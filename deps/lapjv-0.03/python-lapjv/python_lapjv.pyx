...
def lap(np.ndarray cost not None, extend_cost=True, cost_limit=None, return_duals=False, u=None, v=None):
    '''
    ...
    return_duals: add u, v to return
    u: Init value of dual u
    v: Init value of dual v
    ...
    if cost_limit != None or extend_cost:
        ...
        if return_duals:
            return cost[np.nonzero(rowsol_c != -1)[0], rowsol_c[rowsol_c != -1]].sum(), rowsol_c, colsol_c, u_c, v_c
